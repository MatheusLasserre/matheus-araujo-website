        ...
        <div>
            ...
            <div className={heroStyle.heroBackground3}>
                    <div className={heroStyle.heroWrap}>
                        ...
                        <span className={heroStyle.blockText + ' ' + heroStyle.break}> Iniciante ou </span><span className={heroStyle.blockText}>leitor avançado </span>redescobrir e entender o <span className={heroStyle.strong}>poder dos clássicos</span> e extrair todas as transformações que eles podem proporcionar em sua vida.
                        </p>
                        <Button></Button>
